<!--single product page for buyer-->
<!--php to communicate with database-->
<?php
	//get the var value from cookie
...
<body>
	...
	<div class="banner-top">
		<div class="container">
			...
			<em></em>
			<h2><a href="buyer_index.php">Home</a><label>/</label><?php echo $product_category?></h2>
		</div>
	</div>
	<div class="single">
				...
				<div class="col-md-7 single-top-in">
					<div class="span_2_of_a1 simpleCart_shelfItem">
						...
						<p class="quick_desc"><?php 
							...
							$check_con = mysqli_query($con, "SELECT count(*) FROM message_group WHERE (user_one = '$user_id' AND user_two = '$product_sellerid') OR (user_one = '$product_sellerid' AND user_two = '$user_id')" );
						...
						#echo $user_id . "<br>";
							...
							$hash = mysqli_query($con, "SELECT hash FROM message_group WHERE (user_one = '$user_id' AND user_two = '$product_sellerid') OR (user_one = '$product_sellerid' AND user_two = '$user_id')" );
						...
						#echo $hash . "<br>";
							...
							if($result['count(*)'] >= 1){
								...
								echo "<p><a href=\"buyer_conversation.php?hash=" . $hash["hash"] . "\">" . $sellername . "</a></p>";

							}else{
								mysqli_query($con, "INSERT INTO message_group (user_one, user_two, hash) VALUES('$user_id', '$product_sellerid', '$random_number')");
								
								mysqli_query($con, "INSERT INTO messages (group_hash, from_id, message) VALUES ('$random_number','$user_id','$message')");
								echo "<p><a href=\"buyer_start_new_con.php?user=" . $product_sellerid . "\">$sellername</a></p>";
							}
							?></p>
						...
						<div class="tab-content one">
							...
							<div class="tab-pane text-style" id="tab3">
								...
								<div class="col-md-6 login-do">
									<form method="post" action="buyer_single.php?id=<?php echo $product_id; ?>" enctype="multipart/form-data">
										<?php
										...
										?>
										<textarea name="new_comment" cols="60" rows="5" placeholder="comment here" required=""></textarea>
										<br>
		...
		<div class="container">
			...
			<div class="col-md-4 footer-middle-in">
				...
				<ul class="in">
					...
					<li><a href="buyer_contact.html">Contact Us</a></li>
					<li><a href="#">Returns</a></li>
					<li><a href="buyer_contact.html">Site Map</a></li>
				</ul>
				<div class="clearfix"></div>
			</div>
			<div class="col-md-4 footer-middle-in">
