...
//get the username and userid the first time and set in cookies
...
setcookie("isBuyer", $isBuyer, time() + (86400*30), "/");
			...
			<div class="container">
				<div class="content-top">
					<div class="col-md-6 col-md">
						<div class="col-1">
							<a href="buyer_search.php?keyword=Starbucks">
								<img src="images/pi4.jpg" class="img-responsive" alt=""/>
							</a>
						</div>
						<div class="col-2">
							<span>Hot Deal</span>
							<h2><a href="buyer_search.php?keyword=Starbucks">Starbucks series</a></h2>
							...
							<a href="buyer_search.php?keyword=Starbucks" class="buy-now">Buy Now</a>
						</div>
					</div>
					<div class="col-md-6 col-md1">
						<div class="col-3">
							<a href="buyer_product.php?category=Tops"><img src="images/pi1.jpg" class="img-responsive" alt=""><div class="col-pic">
								<p>Fashion</p>
								<label></label>
								<h5>Tops</h5>
							</div></a>
						...
						<div class="col-3">
							<a href="buyer_product.php?category=Toys"><img src="images/pi2.jpg" class="img-responsive" alt=""><div class="col-pic">
								<p>Home & Family</p>
								<label></label>
								<h5>Toys</h5>
							</div></a>
						...
						<div class="col-3">
							<a href="buyer_product.php?category=Hair"><img src="images/pi3.jpg" class="img-responsive" alt=""><div class="col-pic">
								<p>Health & Beauty</p>
								<label></label>
								<h5>Hair</h5>
							</div></a>
