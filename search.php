<!--show search result page for visitors-->
<!--php to retrieve info-->
<?php
	//connect to database
$host = 'localhost';
$user  = 'root';
	...
	<div class="header">
		...
		<div class="banner-top">
			<div class="container">
				...
				<em></em>
				<h2><a href="index.php">Home</a><label>/</label><?php echo $keyword ?></h2>
			</div>
		</div>
		<!--content-->
		<div class="product">
			<div class="container">
				<div class="col-md-9">
					<div class="mid-popular">
						...
						<?php
						if($counter == 0){
							echo "<h2 style=\"color:#FF6C6C;\"c>No item found.</h2><br>";
						}else{
							for($i = 0; $i<$counter; $i++){?>
